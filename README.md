...
Follow [this link](https://infra.devskills.app/transaction-management/api/2.0.0) to find the API documentation. Feel free to try out a few requests to better understand how the API should work.
...
About **1-2 hours**. But don't worry! There is no countdown. This number is for you to plan your time.
